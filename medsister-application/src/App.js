...
export default class App extends Component {
      ...
      messages: [
        {
          user: 0,
          type: "message",
          text: "Hey, Im MedSister how can I help you today?",
          color: "#f1f0f0",
  ...
  handleMessageSubmit = (message) => {
    ...
    socket.on("message", (res) => {
      ...
      this.setState({ auth: res.auth }, () => {
        ...
        if (res.requireAuth && !this.state.auth) {
          ...
          messages.push({
            user: res.user,
            type: res.type,
            text: "Can you please verify your date of birth?",
            color: "#F1F0F0",
            timestamp: res.timestamp,
          });
        } else {
          ...
          if (!res.requireAuth) {
            // changes made here to fix the iteration bug of chatbot repeating repsonses
      ...
      //commenting this line to track the
      ...
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="col-md-3 no-padd-right">
            ...
            >
              <div className="modal-header">
                ...
                <p className="subtext">
                  Everyone in the conversation will see this
                </p>
              </div>
              ...
              <div className="row">
                <div className="col-md-12 col-sm-12">
                  <button className="btn btn-cancel" onClick={this.toggleModal}>
                    Cancel
                  </button>
                </div>
              </div>
          ...
          <div className="col-md-9 no-padd">
            <div
              className="well overflow"
              style={{ height: this.state.height - 106 }}
            >
              {" "}
              {/* Subtract 106 PX from the height for the form */}
              <SearchBar
